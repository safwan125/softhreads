        ...
        <div className="min-h-screen bg-bg">
            <div className="container mx-auto px-4 py-16 max-w-4xl">
                <div className="mb-12 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6 text-primary tracking-tight font-serif">Returns & Exchanges</h1>
                ...
                <div className="grid gap-8 md:grid-cols-2">
                    ...
                    <div className="bg-bg p-8 rounded-2xl shadow-neu border border-secondary/20">
                        <h2 className="text-xl font-semibold mb-4 text-primary font-serif">How to Return</h2>
                    ...
                    {/* Refunds Card */}
                    <div className="bg-bg p-8 rounded-2xl shadow-neu border border-secondary/20">
                        <h2 className="text-xl font-semibold mb-4 text-primary font-serif">Refunds</h2>
                    ...
                    {/* Exchanges Card */}
                    <div className="bg-bg p-8 rounded-2xl shadow-neu border border-secondary/20 md:col-span-2">
                        <h2 className="text-xl font-semibold mb-4 text-primary font-serif">Exchanges</h2>
