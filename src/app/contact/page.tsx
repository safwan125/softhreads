                        ...
                        <form className="space-y-6">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input className="bg-[#8A9A86] text-white placeholder:text-white/80 border-none" />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input type="email" className="bg-[#8A9A86] text-white placeholder:text-white/80 border-none" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-secondary">Message</label>
                                <textarea
                                    className="w-full min-h-[150px] p-3 rounded-xl bg-[#8A9A86] text-white placeholder:text-white/80 border-none focus:outline-none focus:ring-1 focus:ring-accent resize-y"
