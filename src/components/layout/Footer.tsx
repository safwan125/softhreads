...
export default function Footer() {
    return (
        <footer className="bg-background pt-16 pb-8 border-t border-secondary shadow-neu-inner w-full overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-4 pt-2">
                            <Button variant="ghost" size="icon" className="rounded-full w-10 h-10 shadow-neu-sm hover:text-primary" asChild>
                                <a href="https://www.instagram.com/softhreads.official?igsh=cXFheTh4eWRmaWZu&utm_source=qr" target="_blank" rel="noopener noreferrer">
                                    <Instagram className="w-5 h-5" />
                                </a>
                            </Button>
                            <Button variant="ghost" size="icon" className="rounded-full w-10 h-10 shadow-neu-sm hover:text-primary" asChild>
                                <a href="https://www.facebook.com/share/1GMddAioqJ/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer">
                                    <Facebook className="w-5 h-5" />
                                </a>
                            </Button>
                            <Button variant="ghost" size="icon" className="rounded-full w-10 h-10 shadow-neu-sm hover:text-primary relative overflow-hidden group" asChild>
                                <a href="https://wa.me/919048360561?text=Hello,%20I'm%20interested%20in%20Softhreads%20products!" target="_blank" rel="noopener noreferrer">
